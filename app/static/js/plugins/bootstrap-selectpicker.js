  ...
  (function($) {
    ...
    Selectpicker.prototype = {
      ...
      selectPosition: function() {
        ...
        this.$button.on('click.bs.dropdown.data-minor', function() {
          if (that.isDisabled()) {
            return;
          }
      ...
      liveSearchListener: function() {
        ...
        this.$searchbox.on('click.bs.dropdown.data-minor focus.bs.dropdown.data-minor touchend.bs.dropdown.data-minor', function(e) {
          e.stopPropagation();
        });
      ...
      toggle: function(e) {
        ...
        this.$button.trigger('click.bs.dropdown.data-minor');
      },
      ...
      keydown: function(e) {
        ...
        if (
          ...
          that.$button.trigger('click.bs.dropdown.data-minor');
        }

        if (e.which === keyCodes.ESCAPE && isActive) {
          e.preventDefault();
          that.$button.trigger('click.bs.dropdown.data-minor').focus();
        }
    ...
    $(document)
      .off('keydown.bs.dropdown.data-minor')
    ...
    // =====================
    $(window).on('load.bs.select.data-minor', function() {
