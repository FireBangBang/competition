...
class face1():
    ...
    def radio_1(self):
        self.radio = IntVar()
        tk.answer1_message = Radiobutton(self.face1, text=self.timu_and_keys[1], style='B16.TRadiobutton',
                                         variable=self.radio, value=1, command=self.selection, width=800)
        tk.answer1_message.place(x=400, y=230)
        tk.answer2_message = Radiobutton(self.face1, text=self.timu_and_keys[2], style='B16.TRadiobutton',
                                         variable=self.radio, value=2, command=self.selection, width=800)
        tk.answer2_message.place(x=400, y=270)
        tk.answer3_message = Radiobutton(self.face1, text=self.timu_and_keys[3], style='B16.TRadiobutton',
                                         variable=self.radio, value=3, command=self.selection, width=800)
        tk.answer3_message.place(x=400, y=310)
        tk.answer4_message = Radiobutton(self.face1, text=self.timu_and_keys[4], style='B16.TRadiobutton',
                                         variable=self.radio, value=4, command=self.selection, width=800)
...
class face2():
    ...
    def checkbutton(self):
        ...
        for i in range(4):
            ...
            answer_message = Checkbutton(self.face2, text=self.timu_and_keys[i + 1], style='B16.TCheckbutton',
                                         variable=self.checkboxes[i], width=800)
